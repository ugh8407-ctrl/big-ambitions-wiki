...
export function ArticleHeader({ article }: { article: Article }) {
  const labels = article.locale === "fr" ? { verified:"Recherche vérifiée", checked:"Dernière vérification" } : article.locale === "de" ? { verified:"Geprüfte Recherche", checked:"Zuletzt geprüft" } : article.locale === "da" ? { verified:"Kontrolleret research", checked:"Senest kontrolleret" } : { verified:"Verified research", checked:"Last checked" };
