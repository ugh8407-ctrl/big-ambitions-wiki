...
const en = {
  ...
  home: {
    ...
    hero: {
      ...
      titleLead: "Big Ambitions",
      titleAccent: "Wiki & Guides",
      description: "Find answers for your next business decision: choose a starting business, compare investments, set up warehouse deliveries, or find the equipment your shop needs. Start with the beginner guide or jump straight to a specific problem.",
